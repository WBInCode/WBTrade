...
const WHOLESALER_CONFIG: Record<string, { name: string; color: string; bgColor: string; icon: string }> = {
  ...
  'DoFirmy': { name: 'Magazyn Koszalin', color: 'text-cyan-700 dark:text-cyan-400', bgColor: 'bg-cyan-50 dark:bg-cyan-900/30 border-cyan-200 dark:border-cyan-700', icon: '📍' },
  'Rzeszów': { name: 'Magazyn Rzeszów', color: 'text-pink-700 dark:text-pink-400', bgColor: 'bg-pink-50 dark:bg-pink-900/30 border-pink-200 dark:border-pink-700', icon: '📍' },
  'Outlet': { name: 'Magazyn Rzeszów', color: 'text-pink-700 dark:text-pink-400', bgColor: 'bg-pink-50 dark:bg-pink-900/30 border-pink-200 dark:border-pink-700', icon: '📍' },
