...
function AuthCallbackContent() {
  ...
  return (
    <div className="bg-white dark:bg-secondary-800 p-8 rounded-2xl shadow-lg max-w-md w-full mx-4 text-center">
      {status === 'processing' && (
        <>
          <div className="animate-spin rounded-full h-12 w-12 border-4 border-orange-500 border-t-transparent mx-auto mb-4" />
          <h1 className="text-xl font-semibold text-gray-800 dark:text-white">{message}</h1>
        </>
      )}
...
function LoadingFallback() {
  return (
    <div className="bg-white dark:bg-secondary-800 p-8 rounded-2xl shadow-lg max-w-md w-full mx-4 text-center">
      <div className="animate-spin rounded-full h-12 w-12 border-4 border-orange-500 border-t-transparent mx-auto mb-4" />
      <h1 className="text-xl font-semibold text-gray-800 dark:text-white">Ładowanie...</h1>
    </div>
  );
}
...
export default function AuthCallbackPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-green-100 dark:from-secondary-900 dark:to-secondary-800">
