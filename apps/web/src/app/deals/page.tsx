      ...
      <main className="container-custom py-6">
        ...
        <div className="flex gap-6">
          ...
          <aside className="hidden lg:block w-64 flex-shrink-0">
            <div className="bg-white rounded-lg border border-gray-200 p-4 sticky top-24 space-y-6">
              ...
              <div className="bg-red-50 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-semibold text-red-700">Tylko promocje!</span>
                </div>
          ...
          <div className="flex-1">
            ...
            {loading ? (
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">Brak promocji w tej kategorii</h3>
                <p className="text-gray-500 mb-4">Nie znaleziono produktów przecenionych spełniających kryteria.</p>
                <button
                  onClick={() => handleCategoryClick('')}
