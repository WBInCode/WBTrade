      ...
      <main className="py-12">
        <div className="container-custom">
          ...
          <nav className="flex items-center gap-2 text-sm text-secondary-500 mb-8">
            ...
            <span>/</span>
            <span className="text-secondary-900">Zmiana danych konta</span>
          </nav>
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <div className="space-y-4 mb-8">
                  <div className="p-4 bg-secondary-50 rounded-lg">
                    <h4 className="font-medium text-secondary-900 mb-2">👤 Dane podstawowe</h4>
                  ...
                  <div className="p-4 bg-secondary-50 rounded-lg">
                    <h4 className="font-medium text-secondary-900 mb-2">📧 Adres e-mail</h4>
                    <ul className="text-secondary-600 text-sm space-y-1">
                  ...
                  <div className="p-4 bg-secondary-50 rounded-lg">
                    <h4 className="font-medium text-secondary-900 mb-2">🔒 Hasło</h4>
                    <ul className="text-secondary-600 text-sm space-y-1">
                  ...
                  <div className="p-4 bg-secondary-50 rounded-lg">
                    <h4 className="font-medium text-secondary-900 mb-2">🏠 Adresy dostawy</h4>
                    <ul className="text-secondary-600 text-sm space-y-1">
                  ...
                  <div className="p-4 bg-secondary-50 rounded-lg">
                    <h4 className="font-medium text-secondary-900 mb-2">🧾 Dane do faktur</h4>
                    <ul className="text-secondary-600 text-sm space-y-1">
                      <li>• Nazwa firmy</li>
                      <li>• NIP</li>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6 mt-8">
                  <h3 className="font-semibold text-yellow-800 mb-2">⚠️ Nie pamiętasz hasła?</h3>
