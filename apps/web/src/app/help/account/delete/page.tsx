      ...
      <main className="py-12">
        <div className="container-custom">
          ...
          <nav className="flex items-center gap-2 text-sm text-secondary-500 mb-8">
            ...
            <span>/</span>
            <span className="text-secondary-900">Usunięcie konta</span>
          </nav>
          ...
          <div className="max-w-4xl">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              <div className="prose prose-lg max-w-none">
                ...
                <div className="bg-red-50 border border-red-200 rounded-xl p-6 mb-8">
                  <h3 className="font-semibold text-red-800 mb-2">⚠️ Ważne ostrzeżenie</h3>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-3 p-4 bg-secondary-50 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-medium text-secondary-900">Brak aktywnych zamówień</h4>
                  ...
                  <div className="flex items-start gap-3 p-4 bg-secondary-50 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-medium text-secondary-900">Zakończone zwroty</h4>
                      <p className="text-secondary-600 text-sm">
                  ...
                  <div className="flex items-start gap-3 p-4 bg-secondary-50 rounded-lg">
                    <span className="text-xl">💰</span>
                    <div>
                      <h4 className="font-medium text-secondary-900">Brak zaległych płatności</h4>
                      <p className="text-secondary-600 text-sm">
                ...
                <h3 className="text-lg font-medium text-secondary-800 mt-6 mb-3">Metoda 1: Przez panel klienta</h3>
                ...
                <h3 className="text-lg font-medium text-secondary-800 mt-6 mb-3">Metoda 2: Przez kontakt z obsługą</h3>
                <ol className="list-decimal pl-6 text-secondary-600 space-y-2 mb-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mt-8">
                  <h3 className="font-semibold text-blue-800 mb-2">💭 Może zamiast tego...</h3>
                ...
                <div className="bg-primary-50 border border-primary-200 rounded-xl p-6 mt-6">
                  <h3 className="font-semibold text-primary-900 mb-2">📞 Potrzebujesz pomocy?</h3>
            ...
            <div className="mt-8 bg-white rounded-2xl p-6 shadow-sm">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Link href="/help/account/register" className="text-primary-600 hover:text-primary-700 text-sm bg-primary-50 px-4 py-2 rounded-lg">
                  Rejestracja konta
                </Link>
              </div>
            </div>
