      ...
      <main className="py-12">
        <div className="container-custom">
          ...
          <nav className="flex items-center gap-2 text-sm text-secondary-500 dark:text-secondary-400 mb-8">
            ...
            <span>/</span>
            <span className="text-secondary-900 dark:text-white">Polityka zwrotów</span>
          </nav>
            ...
            <div className="bg-white dark:bg-secondary-800 rounded-2xl p-8 shadow-sm">
              <div className="prose prose-lg max-w-none">
                ...
                <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 rounded-xl p-6 mb-6">
                  <h3 className="font-semibold text-green-800 dark:text-green-200 mb-2">✅ 14 dni na zwrot</h3>
                ...
                <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 rounded-xl p-6 mb-6">
                  <p className="text-red-700 dark:text-red-300 mb-3">Zgodnie z ustawą, nie podlegają zwrotowi:</p>
