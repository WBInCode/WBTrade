      ...
      <main className="py-12">
        <div className="container-custom">
          ...
          <nav className="flex items-center gap-2 text-sm text-secondary-500 mb-8">
            ...
            <span>/</span>
            <span className="text-secondary-900">Reklamacja</span>
          </nav>
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-8">
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <h4 className="font-medium text-blue-800 mb-2">📋 Rękojmia (2 lata)</h4>
                    <p className="text-blue-700 text-sm">
                      Odpowiedzialność sprzedawcy za wady towaru. Przysługuje przez 2 lata od zakupu.
                    </p>
                  </div>
                  <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                    <h4 className="font-medium text-green-800 mb-2">🔧 Gwarancja producenta</h4>
                ...
                <div className="space-y-4 mb-8">
                  <div className="p-4 bg-secondary-50 rounded-lg">
                    <h4 className="font-medium text-secondary-900 mb-2">🔧 Naprawa</h4>
                    <p className="text-secondary-600 text-sm">
                      Bezpłatna naprawa wadliwego produktu przez sprzedawcę.
                    </p>
                  </div>
                  <div className="p-4 bg-secondary-50 rounded-lg">
                    <h4 className="font-medium text-secondary-900 mb-2">🔄 Wymiana</h4>
                    <p className="text-secondary-600 text-sm">
                      Wymiana na nowy, wolny od wad egzemplarz tego samego produktu.
                    </p>
                  </div>
                  <div className="p-4 bg-secondary-50 rounded-lg">
                    <h4 className="font-medium text-secondary-900 mb-2">💰 Obniżka ceny</h4>
                    <p className="text-secondary-600 text-sm">
                      Częściowy zwrot pieniędzy proporcjonalny do wady produktu.
                    </p>
                  </div>
                  <div className="p-4 bg-secondary-50 rounded-lg">
                    <h4 className="font-medium text-secondary-900 mb-2">💵 Zwrot pieniędzy</h4>
                    <p className="text-secondary-600 text-sm">
                ...
                <div className="bg-red-50 border border-red-200 rounded-xl p-6 mb-6">
                  <h4 className="font-medium text-red-800 mb-2">⚠️ Sprawdź paczkę przy kurierze</h4>
