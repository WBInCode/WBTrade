      ...
      <main className="py-12">
        <div className="container-custom">
          ...
          <nav className="flex items-center gap-2 text-sm text-secondary-500 mb-8">
            ...
            <span>/</span>
            <span className="text-secondary-900">Problemy z płatnością</span>
          </nav>
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <div className="space-y-4 mb-8">
                  <div className="p-4 bg-red-50 rounded-lg border-l-4 border-red-500">
                    <h4 className="font-medium text-red-800 mb-2">Możliwe przyczyny:</h4>
                  ...
                  <div className="p-4 bg-green-50 rounded-lg border-l-4 border-green-500">
                    <h4 className="font-medium text-green-800 mb-2">Co zrobić:</h4>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6 mt-8">
                  <h3 className="font-semibold text-yellow-800 mb-2">⚠️ Podwójna płatność</h3>
