      ...
      <main className="py-12">
        <div className="container-custom">
          ...
          <nav className="flex items-center gap-2 text-sm text-secondary-500 dark:text-secondary-400 mb-8">
            ...
            <span>/</span>
            <span className="text-secondary-900 dark:text-white">Jak złożyć zamówienie?</span>
          </nav>
          ...
          <div className="max-w-4xl">
            ...
            <div className="mt-8 bg-white dark:bg-secondary-800 rounded-2xl p-6 shadow-sm">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Link href="/shipping" className="text-primary-600 hover:text-primary-700 text-sm bg-primary-50 dark:bg-primary-900/30 px-4 py-2 rounded-lg">
                  Opcje dostawy
                </Link>
              </div>
            </div>
