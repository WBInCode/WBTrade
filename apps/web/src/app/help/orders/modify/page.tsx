...
export const metadata = {
  title: 'Zmiana zamówienia - Centrum pomocy - WB Trade',
  description: 'Dowiedz się jak zmienić szczegóły zamówienia w WB Trade',
};
      ...
      <main className="py-12">
        <div className="container-custom">
          ...
          <nav className="flex items-center gap-2 text-sm text-secondary-500 dark:text-secondary-400 mb-8">
            ...
            <span>/</span>
            <span className="text-secondary-900 dark:text-white">Zmiana zamówienia</span>
          </nav>
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <div className="space-y-4 mb-8">
                  <div className="p-4 bg-secondary-50 dark:bg-secondary-700 rounded-lg">
                    <h4 className="font-medium text-secondary-900 dark:text-white mb-2">📍 Adres dostawy</h4>
                  ...
                  <div className="p-4 bg-secondary-50 dark:bg-secondary-700 rounded-lg">
                    <h4 className="font-medium text-secondary-900 dark:text-white mb-2">📦 Punkt odbioru</h4>
                    <p className="text-secondary-600 dark:text-secondary-400 text-sm">
                  ...
                  <div className="p-4 bg-secondary-50 dark:bg-secondary-700 rounded-lg">
                    <h4 className="font-medium text-secondary-900 dark:text-white mb-2">💳 Metoda płatności</h4>
                    <p className="text-secondary-600 dark:text-secondary-400 text-sm">
                  ...
                  <div className="p-4 bg-secondary-50 dark:bg-secondary-700 rounded-lg">
                    <h4 className="font-medium text-secondary-900 dark:text-white mb-2">🛍️ Produkty w zamówieniu</h4>
                    <p className="text-secondary-600 dark:text-secondary-400 text-sm">
                ...
                <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-700 rounded-xl p-6 mt-8">
                  <h3 className="font-semibold text-yellow-800 dark:text-yellow-200 mb-2">⏰ Czas ma znaczenie</h3>
