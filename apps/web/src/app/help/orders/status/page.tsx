      ...
      <main className="py-12">
        <div className="container-custom">
          ...
          <nav className="flex items-center gap-2 text-sm text-secondary-500 dark:text-secondary-400 mb-8">
            ...
            <span>/</span>
            <span className="text-secondary-900 dark:text-white">Status zamówienia</span>
          </nav>
          ...
          <div className="max-w-4xl">
            ...
            <div className="bg-white dark:bg-secondary-800 rounded-2xl p-8 shadow-sm">
              <div className="prose prose-lg max-w-none">
                ...
                <h3 className="text-lg font-medium text-secondary-800 dark:text-secondary-200 mt-6 mb-3">Dla zalogowanych użytkowników:</h3>
                ...
                <h3 className="text-lg font-medium text-secondary-800 dark:text-secondary-200 mt-6 mb-3">Dla gości (bez konta):</h3>
                <ol className="list-decimal pl-6 text-secondary-600 dark:text-secondary-400 space-y-2 mb-6">
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-4 p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-medium text-secondary-900 dark:text-white">Oczekuje na płatność</h4>
                      <p className="text-secondary-600 dark:text-secondary-400 text-sm">Zamówienie zostało złożone, oczekujemy na potwierdzenie płatności.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-medium text-secondary-900 dark:text-white">Opłacone</h4>
                      <p className="text-secondary-600 dark:text-secondary-400 text-sm">Płatność została potwierdzona, zamówienie czeka na realizację.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-indigo-50 dark:bg-indigo-900/30 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-medium text-secondary-900 dark:text-white">W realizacji</h4>
                      <p className="text-secondary-600 dark:text-secondary-400 text-sm">Zamówienie jest przygotowywane do wysyłki.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-purple-50 dark:bg-purple-900/30 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-medium text-secondary-900 dark:text-white">Wysłane</h4>
                      <p className="text-secondary-600 dark:text-secondary-400 text-sm">Paczka została przekazana kurierowi. Możesz śledzić przesyłkę.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-green-50 dark:bg-green-900/30 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-medium text-secondary-900 dark:text-white">Dostarczone</h4>
                      <p className="text-secondary-600 dark:text-secondary-400 text-sm">Zamówienie zostało dostarczone do odbiorcy.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-red-50 dark:bg-red-900/30 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-medium text-secondary-900 dark:text-white">Anulowane</h4>
                      <p className="text-secondary-600 dark:text-secondary-400 text-sm">Zamówienie zostało anulowane.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="mt-8 bg-white dark:bg-secondary-800 rounded-2xl p-6 shadow-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <Link href="/help/delivery/tracking" className="text-primary-600 hover:text-primary-700 text-sm bg-primary-50 dark:bg-primary-900/30 px-4 py-2 rounded-lg">
                  Śledzenie przesyłki
                </Link>
