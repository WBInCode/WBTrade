      ...
      <main className="py-12">
        <div className="container-custom">
          ...
          <nav className="flex items-center gap-2 text-sm text-secondary-500 mb-8">
            ...
            <span>/</span>
            <span className="text-secondary-900">Ochrona prywatności</span>
          </nav>
          ...
          <div className="max-w-4xl">
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <div className="space-y-4 mb-8">
                  <div className="p-4 bg-secondary-50 rounded-lg">
                    <h4 className="font-medium text-secondary-900 mb-2">📋 Dane podane przez Ciebie</h4>
                  ...
                  <div className="p-4 bg-secondary-50 rounded-lg">
                    <h4 className="font-medium text-secondary-900 mb-2">🛒 Dane z aktywności</h4>
                    <ul className="text-secondary-600 text-sm space-y-1">
                  ...
                  <div className="p-4 bg-secondary-50 rounded-lg">
                    <h4 className="font-medium text-secondary-900 mb-2">🌐 Dane techniczne</h4>
                    <ul className="text-secondary-600 text-sm space-y-1">
                      <li>• Adres IP</li>
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-8">
                  <div className="p-4 bg-primary-50 rounded-lg border border-primary-200">
                    <h4 className="font-medium text-primary-900 mb-2">👁️ Prawo dostępu</h4>
                    <p className="text-primary-700 text-sm">Możesz uzyskać kopię swoich danych</p>
                  </div>
                  <div className="p-4 bg-primary-50 rounded-lg border border-primary-200">
                    <h4 className="font-medium text-primary-900 mb-2">✏️ Prawo do sprostowania</h4>
                    <p className="text-primary-700 text-sm">Możesz poprawić nieprawidłowe dane</p>
                  </div>
                  <div className="p-4 bg-primary-50 rounded-lg border border-primary-200">
                    <h4 className="font-medium text-primary-900 mb-2">🗑️ Prawo do usunięcia</h4>
                    <p className="text-primary-700 text-sm">Możesz żądać usunięcia danych</p>
                  </div>
                  <div className="p-4 bg-primary-50 rounded-lg border border-primary-200">
                    <h4 className="font-medium text-primary-900 mb-2">📤 Prawo do przenoszenia</h4>
                    <p className="text-primary-700 text-sm">Możesz pobrać swoje dane</p>
                  </div>
                  <div className="p-4 bg-primary-50 rounded-lg border border-primary-200">
                    <h4 className="font-medium text-primary-900 mb-2">🚫 Prawo do sprzeciwu</h4>
                    <p className="text-primary-700 text-sm">Możesz sprzeciwić się przetwarzaniu</p>
                  </div>
                  <div className="p-4 bg-primary-50 rounded-lg border border-primary-200">
                    <h4 className="font-medium text-primary-900 mb-2">⏸️ Prawo do ograniczenia</h4>
                    <p className="text-primary-700 text-sm">Możesz ograniczyć przetwarzanie</p>
                  </div>
                </div>
                ...
                <h3 className="text-lg font-medium text-secondary-800 mt-6 mb-3">Ustawienia konta:</h3>
                ...
                <h3 className="text-lg font-medium text-secondary-800 mt-6 mb-3">Ustawienia cookies:</h3>
                <ul className="list-disc pl-6 text-secondary-600 space-y-2 mb-6">
                ...
                <div className="bg-primary-50 border border-primary-200 rounded-xl p-6 mt-8">
                  <h3 className="font-semibold text-primary-900 mb-2">📧 Kontakt w sprawie prywatności</h3>
            ...
            <div className="mt-8 bg-white rounded-2xl p-6 shadow-sm">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Link href="/help/account/delete" className="text-primary-600 hover:text-primary-700 text-sm bg-primary-50 px-4 py-2 rounded-lg">
                  Usunięcie konta
                </Link>
