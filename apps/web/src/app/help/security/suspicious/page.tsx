      ...
      <main className="py-12">
        <div className="container-custom">
          ...
          <nav className="flex items-center gap-2 text-sm text-secondary-500 mb-8">
            ...
            <span>/</span>
            <span className="text-secondary-900">Podejrzana aktywność</span>
          </nav>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              <div className="prose prose-lg max-w-none">
                ...
                <div className="bg-red-50 border border-red-200 rounded-xl p-6 mb-8">
                  <h3 className="font-semibold text-red-800 mb-2">🚨 Działaj natychmiast!</h3>
                ...
                <div className="space-y-4 mb-8">
                  <div className="p-4 bg-yellow-50 rounded-lg border-l-4 border-yellow-500">
                    <h4 className="font-medium text-yellow-800">📧 Nieznane zamówienia</h4>
                    <p className="text-yellow-700 text-sm">Otrzymujesz potwierdzenia zamówień, których nie składałeś.</p>
                  </div>
                  
                  <div className="p-4 bg-yellow-50 rounded-lg border-l-4 border-yellow-500">
                    <h4 className="font-medium text-yellow-800">🔑 Zmiana hasła bez Twojej wiedzy</h4>
                    <p className="text-yellow-700 text-sm">Otrzymałeś e-mail o zmianie hasła, której nie inicjowałeś.</p>
                  </div>
                  
                  <div className="p-4 bg-yellow-50 rounded-lg border-l-4 border-yellow-500">
                    <h4 className="font-medium text-yellow-800">📍 Nieznane adresy dostawy</h4>
                    <p className="text-yellow-700 text-sm">W zamówieniach pojawiają się adresy, których nie dodawałeś.</p>
                  </div>
                  ...
                  <div className="p-4 bg-yellow-50 rounded-lg border-l-4 border-yellow-500">
                    <h4 className="font-medium text-yellow-800">👤 Zmienione dane konta</h4>
                    <p className="text-yellow-700 text-sm">Twoje dane osobowe, e-mail lub telefon zostały zmienione.</p>
                  </div>
                </div>
                ...
                <div className="bg-secondary-50 p-4 rounded-lg mb-6">
                  ...
                  <ul className="list-disc pl-6 text-secondary-600 text-sm space-y-1">
                    <li>Podanie hasła</li>
                ...
                <div className="bg-primary-50 border border-primary-200 rounded-xl p-6 mt-8">
                  <h3 className="font-semibold text-primary-900 mb-2">📞 Pilny kontakt</h3>
