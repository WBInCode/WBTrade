      ...
      <main className="py-12">
        <div className="container-custom">
          ...
          <nav className="flex items-center gap-2 text-sm text-secondary-500 dark:text-secondary-400 mb-8">
            ...
            <span>/</span>
            <span className="text-secondary-900 dark:text-white">Punkty odbioru</span>
          </nav>
                ...
                <div className="space-y-4 mb-8">
                  <div className="p-5 bg-yellow-50 dark:bg-yellow-900/30 rounded-xl border border-yellow-200 dark:border-yellow-700">
                    <div className="flex items-start gap-4">
                      <div className="w-14 h-14 bg-yellow-100 dark:bg-yellow-900/50 rounded-xl flex items-center justify-center text-3xl">📦</div>
                      <div>
                        <h4 className="font-semibold text-secondary-900 dark:text-white text-lg">InPost Paczkomaty 24/7</h4>
                        <p className="text-secondary-600 dark:text-secondary-400 mt-1">
                          Ponad 20 000 paczkomatów w Polsce. Odbiór całą dobę, 7 dni w tygodniu.
                        </p>
                        <ul className="text-secondary-600 dark:text-secondary-400 text-sm mt-2 space-y-1">
                  ...
                  <div className="p-5 bg-blue-50 dark:bg-blue-900/30 rounded-xl border border-blue-200 dark:border-blue-700">
                    <div className="flex items-start gap-4">
                      <div className="w-14 h-14 bg-blue-100 dark:bg-blue-900/50 rounded-xl flex items-center justify-center text-3xl">🏪</div>
                      <div>
                        <h4 className="font-semibold text-secondary-900 dark:text-white text-lg">Żabka</h4>
                        <p className="text-secondary-600 dark:text-secondary-400 mt-1">
                  ...
                  <div className="p-5 bg-red-50 dark:bg-red-900/30 rounded-xl border border-red-200 dark:border-red-700">
                    <div className="flex items-start gap-4">
                      <div className="w-14 h-14 bg-red-100 dark:bg-red-900/50 rounded-xl flex items-center justify-center text-3xl">📮</div>
                      <div>
                        <h4 className="font-semibold text-secondary-900 dark:text-white text-lg">Poczta Polska - Punkt odbioru</h4>
                        <p className="text-secondary-600 dark:text-secondary-400 mt-1">
                  ...
                  <div className="p-5 bg-green-50 dark:bg-green-900/30 rounded-xl border border-green-200 dark:border-green-700">
                    <div className="flex items-start gap-4">
                      <div className="w-14 h-14 bg-green-100 dark:bg-green-900/50 rounded-xl flex items-center justify-center text-3xl">⛽</div>
                      <div>
                        <h4 className="font-semibold text-secondary-900 dark:text-white text-lg">Orlen Paczka</h4>
                        <p className="text-secondary-600 dark:text-secondary-400 mt-1">
