      ...
      <main className="py-12">
        <div className="container-custom">
          ...
          <nav className="flex items-center gap-2 text-sm text-secondary-500 dark:text-secondary-400 mb-8">
            ...
            <span>/</span>
            <span className="text-secondary-900 dark:text-white">Śledzenie przesyłki</span>
          </nav>
          ...
          <div className="max-w-4xl">
            ...
            <div className="bg-white dark:bg-secondary-800 rounded-2xl p-8 shadow-sm">
              <div className="prose prose-lg max-w-none">
                ...
                <h3 className="text-lg font-medium text-secondary-800 dark:text-secondary-200 mt-6 mb-3">Przez panel klienta:</h3>
                ...
                <h3 className="text-lg font-medium text-secondary-800 dark:text-secondary-200 mt-6 mb-3">Na stronie przewoźnika:</h3>
                <ol className="list-decimal pl-6 text-secondary-600 dark:text-secondary-400 space-y-2 mb-6">
                ...
                <div className="space-y-3 mb-8">
                  <div className="flex items-center gap-4 p-4 bg-secondary-50 dark:bg-secondary-900 rounded-lg">
                    <div className="w-12 h-12 bg-yellow-100 dark:bg-yellow-900/50 rounded-lg flex items-center justify-center text-2xl">📦</div>
                    <div>
                      <h4 className="font-medium text-secondary-900 dark:text-white">InPost Paczkomaty</h4>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-secondary-50 dark:bg-secondary-900 rounded-lg">
                    <div className="w-12 h-12 bg-yellow-100 dark:bg-yellow-900/50 rounded-lg flex items-center justify-center text-2xl">🚚</div>
                    <div>
                      <h4 className="font-medium text-secondary-900 dark:text-white">Kurier InPost</h4>
                      <p className="text-primary-600 text-sm">inpost.pl/sledzenie-przesylek</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start gap-4 p-4 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-medium text-secondary-900 dark:text-white">Nadana</h4>
                      <p className="text-secondary-600 dark:text-secondary-400 text-sm">Paczka została przekazana kurierowi/na pocztę.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-indigo-50 dark:bg-indigo-900/30 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-medium text-secondary-900 dark:text-white">W sortowni</h4>
                      <p className="text-secondary-600 dark:text-secondary-400 text-sm">Przesyłka jest przetwarzana w centrum logistycznym.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-purple-50 dark:bg-purple-900/30 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-medium text-secondary-900 dark:text-white">W doręczeniu</h4>
                      <p className="text-secondary-600 dark:text-secondary-400 text-sm">Kurier wyruszył z paczką - dostawa dzisiaj!</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-medium text-secondary-900 dark:text-white">W paczkomacie</h4>
                      <p className="text-secondary-600 dark:text-secondary-400 text-sm">Paczka czeka na odbiór. Masz 48 godzin.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 bg-green-50 dark:bg-green-900/30 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-medium text-secondary-900 dark:text-white">Doręczona</h4>
                      <p className="text-secondary-600 dark:text-secondary-400 text-sm">Paczka została odebrana. Miłych zakupów!</p>
                    </div>
                  </div>
                </div>

                <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-700 rounded-xl p-6 mt-8">
                  <h3 className="font-semibold text-yellow-800 dark:text-yellow-200 mb-2">⏰ Opóźnienie aktualizacji</h3>
            ...
            <div className="mt-8 bg-white dark:bg-secondary-800 rounded-2xl p-6 shadow-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <Link href="/help/delivery/pickup" className="text-primary-600 hover:text-primary-700 text-sm bg-primary-50 dark:bg-primary-900/30 px-4 py-2 rounded-lg">
                  Punkty odbioru
                </Link>
