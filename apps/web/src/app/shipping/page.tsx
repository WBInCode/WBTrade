...
export default function ShippingPage() {
  const shippingMethods = [
    ...
    },
    {
      ...
      features: ['Dostawa do 18:00', 'Możliwość przekierowania', 'Ubezpieczenie'],
    },
    {
      name: 'Odbiór osobisty',
      time: 'W dniu zamówienia',
      price: 'Bezpłatnie',
      freeFrom: null,
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      features: ['Bez kosztów wysyłki', 'Sprawdzenie przed odbiorem', 'Elastyczne godziny'],
    },
  ];
