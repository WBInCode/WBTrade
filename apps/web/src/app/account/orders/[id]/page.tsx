          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-3">
              ...
              <div className="flex gap-3">
                ...
                <button className="px-4 py-2 border border-gray-300 dark:border-secondary-700 text-gray-700 dark:text-gray-300 rounded-lg text-sm font-medium hover:bg-gray-50 dark:hover:bg-secondary-700 transition-colors inline-flex items-center gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
