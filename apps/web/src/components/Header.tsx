            ...
            <div className="flex items-center gap-2 sm:gap-6">
              ...
              <Link href="/wishlist" className="flex flex-col items-center p-2 text-secondary-700 hover:text-primary-500 transition-colors relative group">
                <div className="relative">
                  ...
                  {wishlistCount > 0 && (
                    <span className={`absolute -top-2 -right-2 bg-red-500 text-white text-xs h-5 rounded-full flex items-center justify-center font-bold shadow-sm ${wishlistCount > 99 ? 'w-7 px-1' : 'w-5'}`}>
