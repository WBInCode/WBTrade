  ...
  return (
    <div className="flex flex-col gap-4 mb-6">
      ...
      <div className="flex flex-nowrap items-center justify-end gap-2 sm:gap-3">
        {/* Warehouse filter - always visible */}
        <div className="flex items-center gap-1.5 sm:gap-2 min-w-0">
          <svg className="w-4 h-4 text-gray-500 dark:text-secondary-400 shrink-0 hidden md:block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
          </svg>
          <span className="text-sm text-secondary-500 dark:text-secondary-400 whitespace-nowrap hidden md:inline">Magazyn:</span>
          <select
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 min-w-0">
          <span className="text-sm text-secondary-500 dark:text-secondary-400 hidden md:inline">Sortuj:</span>
          <select
            value={currentSort}
            onChange={(e) => handleSortChange(e.target.value)}
            className="px-2 sm:px-3 py-2 text-xs sm:text-sm border border-gray-300 dark:border-secondary-600 rounded-lg bg-white dark:bg-secondary-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent min-w-0"
          >
