        ...
        <div className="border-b border-secondary-200/50 dark:border-secondary-700/50">
          <div className="container-custom py-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="flex flex-col md:flex-row items-center md:items-center gap-3 md:gap-4 group text-center md:text-left">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center shadow-lg shadow-primary-500/20 group-hover:scale-105 transition-transform flex-shrink-0">
              ...
              <div className="flex flex-col md:flex-row items-center md:items-center gap-3 md:gap-4 group text-center md:text-left">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center shadow-lg shadow-emerald-500/20 group-hover:scale-105 transition-transform flex-shrink-0">
                  <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex flex-col md:flex-row items-center md:items-center gap-3 md:gap-4 group text-center md:text-left">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-violet-500 to-violet-600 flex items-center justify-center shadow-lg shadow-violet-500/20 group-hover:scale-105 transition-transform flex-shrink-0">
                  <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex flex-col md:flex-row items-center md:items-center gap-3 md:gap-4 group text-center md:text-left">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-amber-500 to-amber-600 flex items-center justify-center shadow-lg shadow-amber-500/20 group-hover:scale-105 transition-transform flex-shrink-0">
                  <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
